...
export const useProperties = () => {
  const properties = ref<Property[]>([
    ...
    {
      id: '11',
      title: 'Tokyo Tower View Apartment',
    ...
    {
      id: '12',
      title: 'Paris River Seine Penthouse',
    ...
    {
      id: '18',
      title: 'Rome Colosseum View Penthouse',
      location: 'Rome, Italy',
      price: 2900000,
      beds: 3,
      baths: 3,
    ...
    {
      id: '20',
      title: 'Cape Town Modern Masterpiece',
  ...
  const featuredProperties = ref<Property[]>(properties.value.filter(p => p.featured))
  const newProperties = ref<Property[]>(properties.value.filter(p => !p.featured))
